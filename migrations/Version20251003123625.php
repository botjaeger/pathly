 ...
 */
final class Version20251003123625 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE question (id INT AUTO_INCREMENT NOT NULL, message VARCHAR(255) NOT NULL, active TINYINT(1) NOT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        $this->addSql('CREATE TABLE question_career_weight (id INT AUTO_INCREMENT NOT NULL, question_id INT NOT NULL, career_id INT NOT NULL, yes_weight INT DEFAULT NULL, no_weight INT DEFAULT NULL, INDEX IDX_9D68018E1E27F6BF (question_id), INDEX IDX_9D68018EB58CDA09 (career_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
